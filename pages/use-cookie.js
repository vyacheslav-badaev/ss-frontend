function UseCookie() {
  return (
    <div>
      ...
      <p>Last updated: December 20, 2018</p>
      <p>
        Shortstories ("us", "we", or "our") uses cookies on the
        http:
      ...
      <p>
        ...
        choices regarding cookies and further information about cookies. This
        Cookies Policy for Shortstories is based on the{' '}
        <a href="https:
          TermsFeed's Cookies Policy Template
        </a>
        .
      </p>
      ...
      <h2>How Shortstories uses cookies</h2>
      <p>
      ...
      <p>
        ...
        or refuse cookies, please visit the help pages of your web browser. As
        an European citizen, under GDPR, you have certain individual rights. You
        can learn more about these rights in the{' '}
        <a href="https:
          GDPR Guide
        </a>
        .
